...
#
# Магическая стратегия: каждое испытание открывает 1-2 новые руны. 
# Заклинания плетутся только из уже освоенных знаков, сила врагов растет.
# ─────────────────────────────────────────────────────────────────────────────
const LESSONS_EN := [
	# Испытание 1 ── F J ──────────────────────────────────────────────────────
	{
