...
# Максимальный разблокированный индекс для каждого языка (прогресс)
var current_lesson_en: int = 0
var current_lesson_ru: int = 0

# Индекс уровня, который игрок играет прямо сейчас (может быть старый)
var playing_lesson_en: int = 0
var playing_lesson_ru: int = 0
...
const LESSONS_EN := [
	# Испытание 1 ── F J ──────────────────────────────────────────────────────
	{
		"title": "EN 1", "subtitle": "Домашний ряд: F J",
		"keys": "F · J",
		"lang": "en",
		"new_letters": ["f", "j"],
		"allowed": ["f","j"],
	...
	# Испытание 2 ── + D K ────────────────────────────────────────────────────
	{
		"title": "EN 2", "subtitle": "Домашний ряд: F J D K",
		"keys": "D · F · J · K",
		"lang": "en",
		"new_letters": ["d", "k"],
		"allowed": ["f","j","d","k"],
	...
	# Испытание 3 ── + S L ────────────────────────────────────────────────────
	{
		"title": "EN 3", "subtitle": "Домашний ряд: S D F J K L",
		"keys": "S · D · F · J · K · L",
		"lang": "en",
		"new_letters": ["s", "l"],
		"allowed": ["f","j","d","k","s","l"],
	...
	{
		"title": "EN 4", "subtitle": "Полный домашний ряд: A S D F J K L",
		"keys": "A · S · D · F · J · K · L",
		"lang": "en",
		"new_letters": ["a"],
		"allowed": ["a","s","d","f","j","k","l"],
		"description": "Замыкание контура. Левый мизинец касается руны A. Центральный барьер полностью активирован. В конце уровня появится МИНИБОСС — Одержимая Книга! Отражай её буквы одной клавишей!",
		"words": [
			...
			# Слова минибосса (короткие — легко выстреливать по одной букве)
			"al","as","ad","af","aj","ak","al","sa","sd","sf","da","df","dk","fa","fd","fj",
			"ja","jd","jk","jl","ka","kd","kf","kj","la","ld","lf","lk"
		],
	...
	# Испытание 5 ── + E I ────────────────────────────────────────────────────
	{
		"title": "EN 5", "subtitle": "Верхний ряд: E I",
	...
	# Испытание 6 ── + R U ────────────────────────────────────────────────────
	{
		"title": "EN 6", "subtitle": "Верхний ряд: R U",
		"keys": "... E I  +  R · U",
		"lang": "en",
		"new_letters": ["r", "u"],
	...
	# Испытание 7 ── + T Y ────────────────────────────────────────────────────
	{
		"title": "EN 7", "subtitle": "Верхний ряд: T Y",
		"keys": "... R U  +  T · Y",
		"lang": "en",
		"new_letters": ["t", "y"],
	...
	# Испытание 8 ── + W O ────────────────────────────────────────────────────
	{
		"title": "EN 8", "subtitle": "Верхний ряд: W O",
		"keys": "... T Y  +  W · O",
		"lang": "en",
		"new_letters": ["w", "o"],
	...
	# Испытание 9 ── + Q P ────────────────────────────────────────────────────
	{
		"title": "EN 9", "subtitle": "Верхний ряд: Q P",
		"keys": "... W O  +  Q · P",
		"lang": "en",
		"new_letters": ["q", "p"],
	...
	# Испытание 10 ── + V M ───────────────────────────────────────────────────
	{
		"title": "EN 10", "subtitle": "Нижний ряд: V M",
		"keys": "... Q P  +  V · M",
		"lang": "en",
		"new_letters": ["v", "m"],
	...
	# Испытание 11 ── + C N ───────────────────────────────────────────────────
	{
		"title": "EN 11", "subtitle": "Нижний ряд: C N",
		"keys": "... V M  +  C · N",
		"lang": "en",
		"new_letters": ["c", "n"],
	...
	# Испытание 12 ── + X B ───────────────────────────────────────────────────
	{
		"title": "EN 12", "subtitle": "Нижний ряд: X B",
		"keys": "... C N  +  X · B",
		"lang": "en",
		"new_letters": ["x", "b"],
	...
	# Испытание 13 ── + Z G H ─────────────────────────────────────────────────
	{
		"title": "EN 13", "subtitle": "Нижний ряд: Z  +  G H",
		"keys": "... X B  +  Z · G · H",
		"lang": "en",
		"new_letters": ["z", "g", "h"],
...
const LESSONS_RU := [
	...
	# Испытание 4 ── + Ф ──────────────────────────────────────────────────────
	{
		...
		"description": "Стена Иллюзий. Левый мизинец касается редкой руны Ф. Весь срединный круг магии замкнулся. В конце уровня явится МИНИБОСС — Одержимая Книга! Отражай её буквы одной клавишей!",
		"words": [
			"фол","фала","флаг","дыфо","влодф",
			"вода","лада","фада","довыл","флода",
			"довод","давал","водал","ловда","фавол",
			"вдоль","давол","флодыв","водолы","далофы",
			# Слова минибосса (однобуквенные — для отражения)
			"а","о","в","л","ы","д","ф",
			"ав","ов","ал","ол","аф","оф","вл","вд","лд","ыв","ыл","ыд"
		],
		"spawn_interval": 3.0, "max_enemies": 13, "enemy_speed_mult": 0.62,
		"duration": 105.0, "hp_mult": 0.85,
	},
...
func get_playing_index(lang: String) -> int:
	match lang:
		"en": return playing_lesson_en
		"ru": return playing_lesson_ru
	return 0


func get_current_lesson(lang: String) -> Dictionary:
	return get_lesson(lang, get_playing_index(lang))


func set_lesson(lang: String, index: int) -> void:
	var max_i := get_lesson_count(lang) - 1
	match lang:
		"en": playing_lesson_en = clamp(index, 0, max_i)
		"ru": playing_lesson_ru = clamp(index, 0, max_i)
	emit_signal("lesson_changed", lang, get_playing_index(lang), get_current_lesson(lang))
...
func advance_lesson(lang: String) -> void:
	var playing_idx := get_playing_index(lang)
	var max_unlocked := get_current_index(lang)
	var max_i := get_lesson_count(lang) - 1
	# Продвигаем прогресс только если прошли уровень >= максимального разблокированного
	if playing_idx >= max_unlocked and max_unlocked < max_i:
		match lang:
			"en": current_lesson_en = max_unlocked + 1
			"ru": current_lesson_ru = max_unlocked + 1
		save_progress()
